...
- [x] 4. フロントエンドコンポーネントの実装
  ...
  - [x] 4.2 NavigationControlsコンポーネントを実装する
  ...
  - [x] 4.6 SlideListPageコンポーネントを実装する
  ...
  - [x] 4.7 SlideDetailPageコンポーネントを実装する
  ...
  - [x] 4.8 Appコンポーネントとエントリーポイントを実装する
...
- [x] 7. CDKインフラストラクチャの実装
  - [x] 7.1 SlideViewerStackを実装する
